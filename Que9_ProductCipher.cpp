//Product Cipher Encryption and Decryption Functions
#include <iostream>
#include <string>
#include <algorithm>
using namespace std;
...
// Function to encrypt the message using Row Transposition Cipher for Product Cipher
...
// Function to decrypt the message using Row Transposition Cipher for Product Cipher
    ...
    do{
        ...
        switch(choice){
            case '1':
	    	{
		        ...
		        cout<<endl<<"1st:"<<encodedMsg;
		        string sec= encryptMsg(encodedMsg,key);
		        cout<<endl<<"2nd:"<<sec;
		    ...
		    case '2':
		    {
		        ...
		        cout<<endl<<"1st:"<<decodedMsg;
		        string sec=decryptMsg(decodedMsg,key);
		        cout<<endl<<"2nd:"<<sec;
